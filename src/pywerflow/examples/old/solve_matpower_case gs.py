...
def solve_case(case_path: str, initial:bool = True, **kwargs):
    ...
    try:
        ...
        results = network.gauss_seidel_solve( **kwargs )
    ...
    # results.print_report("all", "all")
    print(f"Iteraciones: {results.meta.iterations}")
    print(results.meta.extras["history_truncated"])
    results.meta.plot_convergence(vline=results.meta.extras["fix_step"], vline_label="fix_step")
    
    network.to_excel(filepath="300net.xlsx")
    results.to_excel(filepath="300res.xlsx")
